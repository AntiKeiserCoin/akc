...
uint256 hashGenesisBlock("0x06458b7d12747ee3db3bc6f588de3ddb7b37600ac912702b87492b023520ddeb");
...
static const int64 nTargetTimespan = 3600; // AntiKeiserCoin: every 25 blocks //will fixed
static const int64 nTargetSpacing = 120; // AntiKeiserCoin: 120 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Max is a Pump and Dump Master. This Coin is ANTI KEISER!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392139290;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1226541;
        ...
        assert(block.hashMerkleRoot == uint256("0xbc5d9508fd8cad5c139a6abfdcf788e73ff034aa8011500bec5781c4dfe4564a"));
